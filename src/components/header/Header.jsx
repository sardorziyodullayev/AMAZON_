		...
		<div className="header">
			<header>
				...
				<div className="language">
					<Link className="language__link" href="index.html">
						<img src="" alt="" />
						<img src="" alt="" />
					</Link>
				</div>
				...
				<div className="card">
					<Link className="card-link" href="index.html">
			...
			<div className="navbar">
				<div className="navbar-nav">
					...
					<div className="navbar-nav-link">
						<Link href="index.html">Today's Deals</Link>
					</div>
					<div className="navbar-nav-link">
						<Link href="index.html">12 Days of Deals</Link>
					</div>
					<div className="navbar-nav-link">
						<Link href="index.html">Customer Service</Link>
					</div>
					<div className="navbar-nav-link">
						<Link href="index.html">Registry</Link>
					</div>
					<div className="navbar-nav-link">
						<Link href="index.html">Gift Cards</Link>
					</div>
					<div className="navbar-nav-link">
						<Link href="index.html">Sell</Link>
					</div>
				</div>
			</div>
		</div>
